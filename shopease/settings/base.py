...
ALLOWED_HOSTS = [
    "shopease-prod.apigateway.in",
    "shopease-alpha.apigateway.in",
    "shopease-beta.apigateway.in",
    "shopease-gamma.apigateway.in",
    "shopease-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [shopease - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
SHOPEASE_SOURCE = "shopease-source"
