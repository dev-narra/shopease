class Status200Response(object):
    ...
    def get_response():
        response = {
            ...
            "response_serializer_import_str": "from shop.build.view_environments.products_low_.get_product_low_stock.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer",
