...
from shop.build.view_environments.orders_.list_orders.ListOrdersRequestQueryParamSerializer import ListOrdersRequestQueryParamSerializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': ListOrdersRequestQueryParamSerializer,
...
def list_orders(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "list_orders", group_name, *args, **kwargs)
