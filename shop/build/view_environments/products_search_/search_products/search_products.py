...
from shop.build.view_environments.products_search_.search_products.SearchProductsRequestQueryParamSerializer import SearchProductsRequestQueryParamSerializer
from shop.build.view_environments.products_search_.search_products.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': SearchProductsRequestQueryParamSerializer,
...
def search_products(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "search_products", group_name, *args, **kwargs)
