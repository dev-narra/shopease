...
from shop.build.view_environments.customers_delete__id__.delete_customer.DeleteCustomerRequestPathParamSerializer import DeleteCustomerRequestPathParamSerializer
from shop.build.view_environments.customers_delete__id__.delete_customer.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_PATH_PARAMS_SERIALIZER': DeleteCustomerRequestPathParamSerializer,
...
def delete_customer(request, *args, **kwargs):
    args = (request,) + args
    from dsu.dsu_gen.openapi.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "delete_customer", group_name, *args, **kwargs)
