...
from shop.build.view_environments.product_update__id_.update_product.UpdateProductRequestPathParamSerializer import UpdateProductRequestPathParamSerializer
