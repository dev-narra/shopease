...
class GetCustomersRequestQueryParamType(object):
...
class GetCustomersRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return GetCustomersRequestQueryParamType(**validated_data)
