...
from shop.build.view_environments.orders_search_.search_orders.SearchOrdersRequestQueryParamSerializer import SearchOrdersRequestQueryParamSerializer
from shop.build.serializers.definitions.OrderList.OrderListSerializer import OrderListSerializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': SearchOrdersRequestQueryParamSerializer,
...
def search_orders(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "search_orders", group_name, *args, **kwargs)
