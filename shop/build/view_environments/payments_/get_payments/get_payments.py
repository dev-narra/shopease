...
from shop.build.view_environments.payments_.get_payments.GetPaymentsRequestQueryParamSerializer import GetPaymentsRequestQueryParamSerializer
from shop.build.view_environments.payments_.get_payments.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
from shop.build.view_environments.payments_.get_payments.responses.Status_400.Status_400.Status_400Serializer import Status_400Serializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': GetPaymentsRequestQueryParamSerializer,
...
def get_payments(request, *args, **kwargs):
    args = (request,) + args
    from dsu.dsu_gen.openapi.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "get_payments", group_name, *args, **kwargs)
