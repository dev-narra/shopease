...
from shop.build.view_environments.todos__id__.get_todo.GetTodoRequestPathParamSerializer import GetTodoRequestPathParamSerializer
...
options = {
    ...
    'DEFAULT_REQUEST_PATH_PARAMS': {"id": 344},
