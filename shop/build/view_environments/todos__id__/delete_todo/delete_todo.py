...
from shop.build.view_environments.todos__id__.delete_todo.DeleteTodoRequestPathParamSerializer import DeleteTodoRequestPathParamSerializer
...
options = {
    ...
    'DEFAULT_REQUEST_PATH_PARAMS': {"id": 603},
