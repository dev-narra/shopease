...
def get_feedback_for_products(*args, **kwargs):  # pylint: disable=invalid-name
    """
    ...
    from dsu.dsu_gen.openapi.server_gen.endpoint_response import \
        endpoint_response
    ...
    from dsu.dsu_gen.openapi.utils.endpoint_response import endpoint_response
