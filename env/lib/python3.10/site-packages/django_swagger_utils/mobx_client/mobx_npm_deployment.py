...
class MobxNpmDeployment(object):
    ...
    def create_template(self):
        ...
        clone_url = 'git@bitbucket.org:example/swagger_mobx_generator.git'
        template_dir = cookiecutter(clone_url, extra_context={"app_name": self.app_name, "author": "Developer",
