...
class CreateCustomApp(object):
    ...
    def create_app_py(self):
        ...
        app_py_file_path = os.path.join(self.base_path, self.app_name, "apps.py")
        from dsu.management.templates.app_template import app_template
    ...
    def get_service_adapter_content(self):
        from dsu.management.templates.service_adapter_template import \
    ...
    def create_init_py(self):
        from dsu.dsu_gen.openapi.utils.get_api_environment import \
        ...
        view_init_file_contents = "EXECUTE_API_TEST_CASE = " + str(
    ...
    def get_fixture_file_content(self):
        from dsu.management.templates.fixture_template import \
            fixture_template
        from django.template.base import Template
        from django.template.context import Context
    ...
    def create_app(self):
        ...
        if check_path_exists(app_base_path):
            ...
            for each_folder in list(folders_list.values()):
                from dsu.utils.mk_dirs import MkDirs
    ...
    def get_sample_api_specs_json(self):
        ...
        :return:
        """
        from dsu.dsu_gen.openapi.utils.sample_spec_file import \
            sample_spec_file
    ...
    def get_model_init_content():
        from dsu.management.templates.model_init_template import \
            model_init_template
        from django.template.base import Template
        from django.template.context import Context
