...
class ParametersGenerator(object):
    ...
    def get_param_context_properties(self, param):
        if param["in"] == "query":
            ...
            from dsu.dsu_gen.openapi.fields.query_parameter_field import query_param_field
            param_context_properties = query_param_field(param, parameter_key_name=self.parameter_name)
        elif param["in"] == "header":

            from dsu.dsu_gen.openapi.fields.header_parameter_field import header_field
            param_context_properties = header_field(param, parameter_key_name=self.parameter_name)
        elif param["in"] == "path":

            from dsu.dsu_gen.openapi.fields.path_parameter_field import path_param_field
        ...
        #     param_context_properties = form_param_field(param, parameter_key_name=self.parameter_name)
            ...
            from dsu.dsu_gen.openapi.fields.body_field import body_field
    ...
    def get_object_properties(prop_name, schema_properties, paths, base_path):
        ...
        from dsu.dsu_gen.openapi.generator.serializer_generator import SerializerGenerator
