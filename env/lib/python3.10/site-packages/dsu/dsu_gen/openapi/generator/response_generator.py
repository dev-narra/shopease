# coding=utf-8
from dsu.dsu_gen.openapi.utils.conf import render
...
class ResponseGenerator(object):
    ...
    def get_response_context_properties(self):
        ...
        if response_schema:
            ...
            from dsu.dsu_gen.openapi.generator.swagger_sample_schema import \
                SwaggerSampleSchema
    ...
    def get_object_properties(self, schema_properties, to_file=True):
        ...
        from dsu.dsu_gen.openapi.generator.serializer_generator import \
            SerializerGenerator
    ...
    def process_headers_serializer_data(self, headers):
        ...
        from dsu.utils.convert_path_to_package_str import \
    ...
    def get_array_field(self, array_header_field, array_name,
        ...
        from dsu.dsu_gen.openapi.utils.collection_fromat_to_separator import \
