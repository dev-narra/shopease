...
class URLGenerator(object):
    ...
    def  generate_url(self):
        ...
        url_v2_file_contents = self.get_url_v2_file_contents(
            self.context_properties, self.parser.base_path())

        url_path = self.dir_paths["url_file"]
        url_v2_path = self.dir_paths["url_v2_file"]

        write_to_file(url_file_contents, url_path)
        write_to_file(url_v2_file_contents, url_v2_path)
    ...
    @staticmethod
    def get_url_v2_file_contents(context_properties, base_path):
        base_path = base_path[1:]
        return render('urls_v2.j2', {"path_names": context_properties,
                                     "base_path": base_path}
                      )
