...
class TestCase01GetUnreadNotificationsCountAPITestCase(ApiTestUtils):
    app_name = APP_NAME
    ...
    NOTIFICATION_DATA = [
        {
            "id": "1958ce6f-843d-46f7-9073-517afe33286b",
            "title": "System Update",
    ...
    def setupUser(self, username, password):
        super(TestCase01GetUnreadNotificationsCountAPITestCase,
              self).setupUser(
            username=username,
            password=password
        )

        self.create_user_unread_notifications()
