...
class TestsLoginWithGoogle:
    ...
    def test_login_with_malformed_google_access_token(self):
        ...
        LoginTestsUtils.login_with_invalid_login_id(
            self.login_interactor, self.login_dto, INVALID_GOOGLE_ACCESS_TOKEN, "Device1")
    ...
    def _init_interactor(self, access_token, social_login_service=None):
        ...
        self.login_interactor = LoginWithGoogle(
            storage_mock, google_service=social_login_service,
