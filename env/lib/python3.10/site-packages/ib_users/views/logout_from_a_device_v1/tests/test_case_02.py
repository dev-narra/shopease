...
class TestCase02LogoutFromADeviceV1APITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def _get_access_token(self, user, app, scope='read write update delete'):
        access_token_object = \
            super(TestCase02LogoutFromADeviceV1APITestCase, self)._get_access_token(
            user, app, scope
        )
    ...
    def setUp(self):
        super(TestCase02LogoutFromADeviceV1APITestCase, self).setUp()
