...
TEST_CASE = {
    "request": {
        ...
        "query_params": {},
        "header_params": {},
        "securities": {"oauth": {"tokenUrl": "http://www.example.com", "flow": "password", "scopes": ["read", "write"], "type": "oauth2"}},
        "body": REQUEST_BODY,
    },
}


class TestCase01LogoutInAllDevicesV1APITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def _get_access_token(self, user, app, scope='read write update delete'):
        access_token_object = \
            super(TestCase01LogoutInAllDevicesV1APITestCase, self)._get_access_token(
            user, app, scope
        )
    ...
    def setUp(self):
        super(TestCase01LogoutInAllDevicesV1APITestCase, self).setUp()
