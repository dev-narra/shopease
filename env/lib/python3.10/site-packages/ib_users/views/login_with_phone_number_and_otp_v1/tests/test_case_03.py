"""
Success Case when device id given while enable_login_devices_information as false
"""
...
class TestCase03LoginWithPhoneNumberAndOtpV1APITestCase(CustomTestUtils):
    app_name = APP_NAME
